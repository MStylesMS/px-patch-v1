...
#define WEB_UI_CONNECTION_CFG_DEFAULT { \
    .wifi_ssid = "Paradox-TFD-1", \
    .wifi_password = "tfd1-jr6t", \
    .mqtt_host = "192.168.8.132", \
    .mqtt_port = 1883, \
    .mqtt_username = "", \
    .mqtt_password = "", \
    .mqtt_base_topic = "/Paradox/TFD/Patch/Prop", \
    .mqtt_game_state_topic = "", \
    .mqtt_prop_announce_topic = "/Paradox/Props", \
    .network_name = "Patch32Prop", \
    .ap_password = "", \
    .ui_password = "", \
    .ap_enabled = false, \
}
