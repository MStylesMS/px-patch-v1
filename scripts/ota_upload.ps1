...
# Legacy patch32: POST /ota
# New px-patch-v1: POST /api/ota/upload
#
# Usage:
#   .\scripts\ota_upload.ps1 -HostAddress 192.168.8.51 -Legacy
#   .\scripts\ota_upload.ps1 -HostAddress 192.168.8.51
param(
    [string]$HostAddress = "",
    [string]$Url = "",
    [string]$Bin = "",
...
if (-not $Bin) {
    $Bin = Join-Path $root "build\px-patch-v1.bin"
}
